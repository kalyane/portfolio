...
export default class Hammer extends Weapon
{
    static asset_name = 'hammer'
    ...
    preSetModel(){
        ...
        const boxGeo = new THREE.BoxGeometry(2, 5, 1)
        boxGeo.applyMatrix4( new THREE.Matrix4().makeTranslation( 0, 2.5, 0 ) )

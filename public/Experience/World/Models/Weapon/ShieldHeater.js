...
export default class ShieldHeater extends Weapon
{
    static asset_name = 'shield_heater'
    ...
    preSetModel(){
        ...
        boxGeo.applyMatrix4( new THREE.Matrix4().makeTranslation( 0, 1.25, 0 ) )
        ...
        this.offsetPos = new THREE.Vector3(38, 33.97, -20);

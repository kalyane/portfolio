...
export default class SwordBig extends Weapon
{
    static asset_name = 'sword_big'
    ...
    preSetModel(){
        ...
        const boxGeo = new THREE.BoxGeometry(1, 6.5, 1)
        ...
        this.offsetPos = new THREE.Vector3(-20, -0.7, 25);
